    ...
    <main>
        ...
        <div class="relative w-full h-[50vh] md:h-[60vh] bg-gray-900 overflow-hidden">
            ...
            <div class="relative h-full flex flex-col items-center justify-center text-center px-4 max-w-5xl mx-auto pt-28">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 uppercase tracking-tight shadow-sm">{{ $lokasi->nama }}</h1>
                <p class="text-xl text-gray-200 font-medium tracking-wide">SUPER LOCATION and EYE-CATCHING DOOH Billboard in Sumatera</p>
            </div>
        </div>
